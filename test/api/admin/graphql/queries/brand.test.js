...
import {
  ADMIN_BRAND as BRAND,
  ADMIN_ALL_BRANDS as ALL_BRANDS,
  ADMIN_ALL_BRANDS_META as ALL_BRANDS_META,
...
describe("Admin GraphQL", () => {
  describe("authentication", () => {
    ...
    context("AdminBrand", () => {
      ...
      it("Get admin brand with invalid id", () => {
        variables.id = "aaaaa";
      ...
      it("Get admin brand with id which does not exist", () => {
