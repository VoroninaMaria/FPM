...
import { ADMIN_CREATE_FILE_MUTATION as CREATE_FILE } from "@local/test/api/mutations.js";
...
describe("Admin GraphQL", () => {
  ...
  describe("mutation { createFile }", () => {
    ...
    it("Should create file for admin when merchant_id is not provided", () => {
      variables.data =
        "data:image/png;base64,";
    ...
    it("Should return error when file with passed name already exists", async () => {
      const file = await Database("files").where({ name: "test2" }).first();

      variables.name = file.name;
      variables.merchant_id = file.account_id;
      variables.data =
        "data:image/png;base64,";
