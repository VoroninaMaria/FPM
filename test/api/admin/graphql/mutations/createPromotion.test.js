...
import { ADMIN_CREATE_PROMOTION_MUTATION as CREATE_PROMOTION } from "@local/test/api/mutations.js";
  ...
  describe("mutation { createPromotion }", () => {
    it("Should create promotion with valid params provided", () => {
      ...
      return accountGraphQLRequest(requestBody(CREATE_PROMOTION), (res) => {
        ...
        expect(createPromotion).to.have.property(
          "merchant_id",
    ...
    it("Should return error when merchant_id has wrong format", () => {
      variables.title = "Best offer";
      variables.text = "text";
      variables.merchant_id = "aaaaaaaaa";
      variables.file_id = file_id;
      variables.start_date = "2022-10-26";
      variables.end_date = "2022-10-26";
