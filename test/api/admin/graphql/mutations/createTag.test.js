...
import { ADMIN_CREATE_TAG_MUTATION as CREATE_TAG } from "@local/test/api/mutations.js";
...
describe("Admin GraphQL", () => {
  ...
  describe("mutation { createTag }", () => {
    it("Should create tag with valid name and merchant_id provided", () => {
      ...
      return accountGraphQLRequest(requestBody(CREATE_TAG), (res) => {
        ...
        expect(createTag).to.have.property(
          "merchant_id",
