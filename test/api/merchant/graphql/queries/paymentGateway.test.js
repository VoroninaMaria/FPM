...
describe("Merchant GraphQL", () => {
  describe("authentication", () => {
    ...
    context("Payment Gateway", () => {
      it("Get paymentGateway without id", () =>
      ...
      it("Get paymentGateway with invalid id", () => {
        variables.id = "aaaaa";
      ...
      it("Get paymentGateway with id which does not exist", () => {
      ...
      it("Get paymentGateway with valid id", async () => {
