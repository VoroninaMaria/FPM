...
import { CREATE_BLOCK_MUTATION as CREATE_BLOCK } from "@local/test/api/mutations.js";
  ...
  describe("mutation { createBlock }", () => {
    context("Shared cases", () => {
      it("Should return error when no name provided", () => {
        ...
        return accountGraphQLRequest(requestBody(CREATE_BLOCK), (res) => {
      ...
      it("Should return error when page_id has wrong format", () => {
        variables.name = "my block";
        variables.blocks = 1;
        variables.position = 1;
        variables.type = "EmptyBlock";
    ...
    context("EmptyBlock", () => {
      it("Should create EmptyBlock with valid params provided", () => {
        variables.name = "my block";
        variables.blocks = 1;
        variables.position = 1;
        variables.type = "EmptyBlock";
        ...
        return accountGraphQLRequest(requestBody(CREATE_BLOCK), (res) => {
          ...
          expect(res.body.data).to.have.property("createBlock");
          expect(createBlock).to.have.property("name", variables.name);
          expect(createBlock).to.have.property("page_id", variables.page_id);
        });
      });
    });

    context("Image", () => {
      it("Should create Image with valid params provided", () => {
        variables.name = "my block";
        variables.blocks = 1;
        variables.position = 1;
      ...
      it("Should create Image with valid params without href provided", () => {
        variables.name = "my block";
        variables.blocks = 1;
        variables.position = 1;
        variables.type = "Image";
      ...
      it("Should return error when href is not string", () => {
        variables.name = "my block";
        variables.blocks = 1;
        variables.position = 1;
        variables.type = "Image";
    ...
    context("Text", () => {
      it("Should create Text with valid params and styles provided", () => {
        variables.name = "my block";
        variables.blocks = 1;
        variables.position = 1;
        variables.type = "Text";
      ...
      it("Should create Text with valid params without styles provided", () => {
        variables.name = "my block";
        variables.blocks = 1;
        variables.position = 1;
        variables.type = "Text";
    ...
    context("TextInput", () => {
      it("Should create TextInput with valid params and styles provided", () => {
        variables.name = "my block";
        variables.blocks = 1;
        variables.position = 1;
      ...
      it("Should create TextInput with valid params without styles provided", () => {
        variables.name = "my block";
        variables.blocks = 1;
        variables.position = 1;
        variables.type = "TextInput";
    ...
    context("PhoneInput", () => {
      it("Should create PhoneInput with valid params and styles provided", () => {
        variables.name = "my block";
        variables.blocks = 1;
        variables.position = 1;
      ...
      it("Should create PhoneInput with valid params without styles provided", () => {
        variables.name = "my block";
        variables.blocks = 1;
        variables.position = 1;
        variables.type = "PhoneInput";
    ...
    context("Button", () => {
      it("Should create Button with valid params and styles provided", () => {
        variables.name = "my block";
        variables.blocks = 1;
        variables.position = 1;
      ...
      it("Should create Button with valid params without styles provided", () => {
        variables.name = "my block";
        variables.blocks = 1;
        variables.position = 1;
        variables.type = "Button";
