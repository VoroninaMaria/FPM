...
class Datex {
  ...
  createClientAccount = async (params) =>
    this.knex("accounts")
      .insert({ ...params })
      .returning("*")
  ...
  getClientAccount = async (account_owner) =>
    this.knex("accounts")
      .select("*")
  ...
  createQRCard = async (in_id_client) =>
    this.knex
      .select("*")
      .from(
        this.knex.raw(
  ...
  updateQRCardPin = async (card_id, new_pin) =>
    this.knex("cards")
      .where({ id: card_id })
      .update({ pin1: new_pin })
      .returning("*")
  ...
  getClientQRCard = async (card_owner) =>
    this.knex("cards")
      .select("*")
      .where({ card_owner })
      .first()
  ...
  getClientJurQRCard = async (code_edroup, phone) =>
    this.knex("clients")
      .select("*")
      .where({ code_edroup })
      .first()
  ...
  createQRCardAccount = async (in_id_card) =>
    this.knex
      .select("*")
      .from(
        this.knex.raw(
  ...
  clientIdByExternalId = async (external_id) =>
    this.knex("clients")
      .select("id_clients")
      .where({ external_id })
      .first()
  ...
  getBalance = async (account_owner) =>
    this.knex("accounts")
      .select("balance")
      .where({ account_owner, active: true })
      .first()
  ...
  getClientTransactions = async (filter, card_owner) =>
  ...
  getClientTopUpTransactions = async (filter, id_clients) =>
    this.knex("docums")
      .select("*")
  ...
  getTotalTransactions = async (filter) =>
    this.knex("transactions_ps")
      .where(
        this.knex.raw(
          "card_owner IN (SELECT id_clients FROM clients WHERE external_id IS NOT NULL)"
