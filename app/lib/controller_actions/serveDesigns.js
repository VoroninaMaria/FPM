...
const loadPages = (design_id, merchant_id, res) =>
  Database("designs")
        ...
        .then((dbPages) =>
          Database("blocks")
            ...
            .then((blocks) => {
              ...
              return res.send(JSON.stringify({ ...design, pages }));
            })
        )
    );

const serveDesigns = (req, res, next) => {
  ...
  return Database("merchants")
    ...
    .then((merchant) => {
      ...
      return loadPages(design_id, id, res);
    });
};

export default serveDesigns;
