...
describe("Membership tab tests", () => {
  ...
  it("Create membership", async () => {
    ...
    const membershipName = await driver
      ...
      .getText();
    const membershipMerchant = await driver
      .wait(
        until.elementLocated(
          By.css(
    ...
    expect(membershipMerchant).to.not.be.empty;
    ...
    const membershipName1 = await driver
      ...
      .getText();
    const membershipMerchant1 = await driver
      .wait(
        until.elementLocated(
          By.css(
            "#main-content > div > div.RaShow-main > div > div > div > span.MuiStack-root.ra-field.ra-field-merchant_id.RaSimpleShowLayout-row > span > a > span"
    ...
    expect(membershipMerchant1).to.not.be.empty;
