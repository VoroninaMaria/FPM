...
describe("Image block tab tests", () => {
  let driver;
  ...
  // Image type
  it("Create block with type image", async () => {
    ...
    await driver
      .wait(until.elementLocated(By.css("[data-value='Image']")), 2000)
      .click();
    ...
    // image select
    await driver
      .wait(until.elementLocated(By.id("props.file_id")), 2000)
      .click();
    ...
    expect(blockType).to.equal("Зображення");
    ...
    await driver
      .wait(until.elementLocated(By.id("styles.resizeMode")), 2000)
      .click();
    await driver
      .wait(until.elementLocated(By.css("[data-value='cover']")), 2000)
      .click();
  ...
  it("Element image already exist", async () => {
    await driver.get(`${Config.serverUrl}/#/Block`);
    await driver.wait(until.urlIs(`${Config.serverUrl}/#/Block`), 2000);
